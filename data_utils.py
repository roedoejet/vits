...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_and_text, hparams):
        ...
        self.sampling_rate = hparams.sampling_rate
        self.adapter_feature_dir = hparams.adapter_feature_dir
    ...
    def get_audio_text_pair(self, audiopath_and_text):
        ...
        dur, energy, pitch = self.get_adapter_features(audiopath)
        return (text, spec, wav, dur, energy, pitch)

    def get_adapter_features(self, audiopath):
        bn, _ = os.path.splitext(os.path.basename(audiopath))
        dur_path = os.path.join(
            self.adapter_feature_dir, "duration", "0-duration-{}.npy".format(bn)
        )
        energy_path = os.path.join(
            self.adapter_feature_dir, "energy", "0-energy-{}.npy".format(bn)
        )
    ...
    def get_audio(self, filename):
        ...
        # DONE: remove all .spec.pt for PENAC
...
class TextAudioCollate:
    ...
    def __call__(self, batch):
        ...
        PARAMS
        ------
        batch: [text_normalized, spec_normalized, wav_normalized, dur_normalized, energy_normalized, pitch_normalized]
        """
