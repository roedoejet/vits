...
class VarianceAdaptor(nn.Module):
    ...
    def __init__(self, preprocess_config, model_config):
        ...
        self.pitch_embedding = nn.Embedding(n_bins, model_config["hidden_channels"])
        self.energy_embedding = nn.Embedding(n_bins, model_config["hidden_channels"])
...
class VariancePredictor(nn.Module):
    ...
    def __init__(self, model_config):
        ...
        self.input_size = model_config["hidden_channels"]
